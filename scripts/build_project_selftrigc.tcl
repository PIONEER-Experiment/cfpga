...
# Create project
create_project WFD_Channel_selftrigc $origin_dir/project_selftrigc

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects WFD_Channel_selftrigc]
...
set obj [get_filesets sources_1]
set_property "top" "channel_main_selftrigc" $obj
...
set cflist [glob $origin_dir/constraints/self_trigc/ios.xdc \
                 $origin_dir/constraints/self_trigc/timing.xdc \
...
set ciflist [glob $origin_dir/constraints/self_trigc/ios.xdc \
                  $origin_dir/constraints/self_trigc/timing.xdc \
...
set file "$origin_dir/sim/channel_main_selftrigc_tb1.v"
set file [file normalize $file]
...
set_property "top" "channel_main_selftrigc_tb1" $obj
...
puts "INFO: Project created: WFD_Channel_selftrigc"
