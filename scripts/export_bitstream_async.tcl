...
if {[file exists ./channel_main_async.bit]} {
  file copy -force ./channel_main_async.bit [file dirname [info script]]/../bitstreams/wfd_channel_async_$version.bit
  puts "INFO: Bitstream copied: wfd_channel_async.bit"
  write_cfgmem -force -format MCS -size 32 -interface SPIx1 \
      -loadbit "up 0x012E0000 ./channel_main_async.bit" [file dirname [info script]]/../bitstreams/wfd_channel_async_$version
} else {
...
if {[file exists ./debug_nets.ltx]} {
  file copy -force ./debug_nets.ltx [file dirname [info script]]/../bitstreams/wfd_channel_async_$version.ltx
