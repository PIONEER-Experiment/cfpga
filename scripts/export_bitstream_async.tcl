...
if {[file exists ./channel_main_async.bit]} {
  ...
  write_cfgmem -force -format MCS -size 32 -interface SPIx1 \
      -loadbit "up 0xCE0000 ./channel_main_async.bit" [file dirname [info script]]/../bitstreams/wfd_channel_async
} else {
...
if {[file exists ./debug_nets.ltx]} {
  file copy -force ./debug_nets.ltx [file dirname [info script]]/../debugs/debug_channel_async.ltx
