...
# Create project
create_project WFD_Channel_CBUF $origin_dir/project_cbuf

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects WFD_Channel_CBUF]
...
set obj [get_filesets sources_1]
set_property "top" "channel_main_cbuf" $obj
...
set cflist [glob $origin_dir/constraints/cbuf/ios.xdc \
...
set ciflist [glob $origin_dir/constraints/cbuf/ios.xdc \
                  $origin_dir/constraints/cbuf/timing.xdc \
...
set file "$origin_dir/sim/channel_main_cbuf_tb1.v"
set file [file normalize $file]
...
set_property "top" "channel_main_cbuf_tb1" $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  ...
  # create_run -name impl_1 -part xc7k70tfbg484-2 -flow {Vivado Implementation 2023} -strategy "Performance_Explore" -constrset constrs_impl_1 -parent_run synth_1
} else {
...
set_property "steps.write_bitstream.tcl.post" "[file normalize "$origin_dir/scripts/export_bitstream_cbuf.tcl"]" $obj

# set the current impl run
current_run -implementation [get_runs impl_1]

puts "INFO: Project created: WFD_Channel_CBUF"
