...
# Create project
create_project WFD_Channel_selftrig $origin_dir/project_selftrig

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects WFD_Channel_selftrig]
...
set obj [get_filesets sources_1]
set_property "top" "channel_main_selftrig" $obj
...
set file "$origin_dir/sim/channel_main_selftrig_tb1.v"
set file [file normalize $file]
...
set_property "top" "channel_main_selftrig_tb1" $obj

# Create 'synth_1' run (if not found)
if {[string equal [get_runs -quiet synth_1] ""]} {
  create_run -name synth_1 -part xc7k70tfbg484-2 -flow {Vivado Synthesis 2023} -strategy "Flow_PerfOptimized_high" -constrset constrs_1
} else {
...
puts "INFO: Project created: WFD_Channel_selftrig"
