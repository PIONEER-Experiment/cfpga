...
# this line was causing all sorts of errors in non-project mode
# although it didn't seem to bother anything in project mode
...
set_property INTERFACE adc_data [get_ports { adc_d0n adc_d0p adc_d1n adc_d1p adc_d2n adc_d2p adc_d3n adc_d3p adc_d4n adc_d4p adc_d5n adc_d5p adc_d6n adc_d6p adc_d7n adc_d7p adc_d8n adc_d8p adc_d9n adc_d9p adc_d10n adc_d10p adc_d11n adc_d11p adc_dovrn adc_dovrp }]
...
#set_property INTERFACE serial_xcvrs [get_ports { c0_rx c0_rx_N c1_rx c1_rx_N c2_rx c2_rx_N c3_rx c3_rx_N c0_tx c0_tx_N c1_tx c1_tx_N c2_tx c2_tx_N c3_tx c3_tx_N xcvr_clk xcvr_clk_N }]
...
set_property IOSTANDARD SSTL15_DCI [get_ports {ddr3_dm[0]}]
...
set_property IOSTANDARD SSTL15_DCI [get_ports {ddr3_dm[1]}]
...
set_property IOSTANDARD SSTL15_DCI [get_ports {ddr3_ba[2]}]
set_property IOSTANDARD SSTL15_DCI [get_ports {ddr3_ba[1]}]
set_property IOSTANDARD SSTL15_DCI [get_ports {ddr3_ba[0]}]
set_property IOSTANDARD SSTL15_DCI [get_ports {ddr3_addr[12]}]
set_property IOSTANDARD SSTL15_DCI [get_ports {ddr3_addr[11]}]
set_property IOSTANDARD SSTL15_DCI [get_ports {ddr3_addr[10]}]
set_property IOSTANDARD SSTL15_DCI [get_ports {ddr3_addr[9]}]
set_property IOSTANDARD SSTL15_DCI [get_ports {ddr3_addr[8]}]
set_property IOSTANDARD SSTL15_DCI [get_ports {ddr3_addr[7]}]
set_property IOSTANDARD SSTL15_DCI [get_ports {ddr3_addr[6]}]
set_property IOSTANDARD SSTL15_DCI [get_ports {ddr3_addr[5]}]
set_property IOSTANDARD SSTL15_DCI [get_ports {ddr3_addr[4]}]
set_property IOSTANDARD SSTL15_DCI [get_ports {ddr3_addr[3]}]
set_property IOSTANDARD SSTL15_DCI [get_ports {ddr3_addr[2]}]
set_property IOSTANDARD SSTL15_DCI [get_ports {ddr3_addr[1]}]
set_property IOSTANDARD SSTL15_DCI [get_ports {ddr3_addr[0]}]
...
set_property PACKAGE_PIN U5 [get_ports {ddr3_addr[0]}]
set_property PACKAGE_PIN M3 [get_ports {ddr3_addr[1]}]
set_property PACKAGE_PIN T5 [get_ports {ddr3_addr[2]}]
...
set_property PACKAGE_PIN N5 [get_ports {ddr3_addr[6]}]
set_property PACKAGE_PIN R3 [get_ports {ddr3_addr[7]}]
set_property PACKAGE_PIN P4 [get_ports {ddr3_addr[8]}]
set_property PACKAGE_PIN R4 [get_ports {ddr3_addr[9]}]
set_property PACKAGE_PIN K2 [get_ports {ddr3_addr[10]}]
set_property PACKAGE_PIN N4 [get_ports {ddr3_addr[11]}]
set_property PACKAGE_PIN L4 [get_ports {ddr3_addr[12]}]
set_property PACKAGE_PIN V4 [get_ports {ddr3_ba[0]}]
set_property PACKAGE_PIN L5 [get_ports {ddr3_ba[1]}]
set_property PACKAGE_PIN W4 [get_ports {ddr3_ba[2]}]
set_property PACKAGE_PIN AA4 [get_ports ddr3_cas_n]
set_property PACKAGE_PIN K3 [get_ports ddr3_cke]
set_property PACKAGE_PIN P2 [get_ports ddr3_ck_p]
set_property PACKAGE_PIN W5 [get_ports ddr3_cs_n]
set_property PACKAGE_PIN Y1 [get_ports {ddr3_dq[0]}]
set_property PACKAGE_PIN N2 [get_ports {ddr3_dq[1]}]
set_property PACKAGE_PIN W2 [get_ports {ddr3_dq[2]}]
set_property PACKAGE_PIN N3 [get_ports {ddr3_dq[3]}]
set_property PACKAGE_PIN V3 [get_ports {ddr3_dq[4]}]
set_property PACKAGE_PIN U2 [get_ports {ddr3_dq[5]}]
set_property PACKAGE_PIN W1 [get_ports {ddr3_dq[6]}]
set_property PACKAGE_PIN T3 [get_ports {ddr3_dq[7]}]
set_property PACKAGE_PIN M1 [get_ports {ddr3_dq[8]}]
set_property PACKAGE_PIN AA3 [get_ports {ddr3_dq[9]}]
set_property PACKAGE_PIN L3 [get_ports {ddr3_dq[10]}]
set_property PACKAGE_PIN AA1 [get_ports {ddr3_dq[11]}]
set_property PACKAGE_PIN K1 [get_ports {ddr3_dq[12]}]
set_property PACKAGE_PIN AB1 [get_ports {ddr3_dq[13]}]
set_property PACKAGE_PIN L1 [get_ports {ddr3_dq[14]}]
set_property PACKAGE_PIN AB2 [get_ports {ddr3_dq[15]}]
set_property PACKAGE_PIN M2 [get_ports {ddr3_dm[0]}]
set_property PACKAGE_PIN T1 [get_ports {ddr3_dqs_p[0]}]
set_property PACKAGE_PIN Y4 [get_ports ddr3_odt]
set_property PACKAGE_PIN AB3 [get_ports ddr3_ras_n]
set_property PACKAGE_PIN P5 [get_ports ddr3_reset_n]
set_property PACKAGE_PIN Y2 [get_ports {ddr3_dm[1]}]
set_property PACKAGE_PIN P1 [get_ports {ddr3_dqs_p[1]}]
set_property PACKAGE_PIN Y3 [get_ports ddr3_we_n]
