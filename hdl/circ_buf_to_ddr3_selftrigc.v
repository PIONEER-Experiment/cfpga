...
module circ_buf_to_ddr3_selftrigc (
    // inputs
...
adc_dat_mux_selftrigc adc_dat_mux_selftrigc (
    // inputs
    ...
    .fill_addr(fill_address[22:0]),                // first DDR3 memory location for this fill
...
circ_buf_to_ddr3_sm_selftrigc circ_buf_to_ddr3_sm_selftrigc (
    // inputs
    .adc_clk(adc_clk),
