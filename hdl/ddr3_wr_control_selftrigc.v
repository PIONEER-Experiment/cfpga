...
module ddr3_wr_control_selftrigc (
    ...
    output reg init_address_gen,          // output, flags when we are initializing the address for a new fill
...
always @ (posedge clk) begin
    ...
    else if (init_address_gen) address_gen[22:0] <= ddr3_wr_fifo_dat[75:53];
