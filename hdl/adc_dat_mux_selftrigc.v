...
assign fill_header[125:124] = 1'b1;                       //  1-bit circular-buffered self triggered = 1, all others 0
assign fill_header[125:125] = 1'b0;                       //  1-bit unused
...
assign waveform_header[ 25: 14] = async_pre_trig[13:2];             // 12-bit MSB value for number of pre-trigger bursts register R21 (which has pairs)
...
assign waveform_header[107: 98] = channel_tag[9:0];                 // 12-bit channel tag
assign waveform_header[109:108] = async_pre_trig[1:0];              //  2-bit LSB value for number of pre-trigger bursts register R21 (which has pairs)
