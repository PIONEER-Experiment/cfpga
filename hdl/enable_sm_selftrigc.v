...
module enable_sm_selftrigc (
    ...
    input new_fill,             // a new fill has been requested, so we need to wrap up the current fill
    // outputs
...
always @ (CS or trig_ready_sync2 or cbuf_rd_trig_wait or ddr3_wr_done_sync2 or pulse_cntr_zero or new_fill ) begin
